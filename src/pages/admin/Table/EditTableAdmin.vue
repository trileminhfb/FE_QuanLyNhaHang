...
import { ref, onMounted, computed, watch, reactive } from "vue"; import ConfirmDelete from '../../../components/Admin/ConfirmDelete.vue';
...
async function goSave() {
    try {
        const response = await axios.put(`http:// 192.168.1.53:8888/api/admin/tables/${tableData.id}`, {
