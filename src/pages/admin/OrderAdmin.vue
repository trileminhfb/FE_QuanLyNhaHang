                            ...
                            <tr v-for="(item, index) in paginatedItems" :key="index" class="border-2 border-gray-300">
                                ...
                                <td>
                                    <div class="h-16 flex justify-center items-center px-2">
                                        <div v-if="item.status === 1" class="bg-green-500 p-2">Hoàn thành
                                        </div>
                                        <div v-else-if="item.status === 2" class="bg-red-500 p-2">Bị huỷ
                                        </div>
                                        <div v-else-if="item.status === 3" class="bg-yellow-500 p-2">Đang sử dụng
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <p class="hover:bg-gray-500 text-start w-full h-full"
                                                    @click="goDetailOrders">Chi tiết</p>
...
const allItems = ref([
    { id: '1', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 1', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
    { id: '2', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 2', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
    { id: '3', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 3', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
    { id: '4', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 4', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
    { id: '5', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 5', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
    { id: '6', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 6', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
    { id: '7', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 7', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
    { id: '8', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 8', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
    { id: '8', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 8', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
    { id: '8', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 8', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
    { id: '8', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 8', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
    { id: '8', status: Math.floor(Math.random() * 3) + 1, name: 'bàn 8', time_start: '', time_use: '', total: (Math.floor(Math.random() * 10000) + 1) * 1000, },
...
function goDetailOrders() {
    router.push('/admin/orders/details-orders')
}
</script>