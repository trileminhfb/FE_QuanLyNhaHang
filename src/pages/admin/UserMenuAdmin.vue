                ...
                <tbody>
                    <tr v-for="(item, index) in paginatedItems" :key="index" class="border-2 border-gray-300">
                        ...
                        <td class="text-center">
                            <div v-if="item.role === 1" class="w-full flex justify-center">
                                <p class="bg-blue-300 px-2">Diamond</p>
                            </div>
                            <div v-else-if="item.role === 2" class="w-full flex justify-center">
                                <p class="bg-yellow-300 px-2">Gold</p>
                            </div>
                            <div v-else-if="item.role === 3" class="w-full flex justify-center">
...
const allItems = ref([
    { name: 'Name 1', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 2', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 3', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 4', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 5', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 6', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 7', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 8', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 9', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 10', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 11', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 12', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 13', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 14', role: Math.floor(Math.random() * 3 + 1) },
    { name: 'Name 15', role: Math.floor(Math.random() * 3 + 1) },
])
