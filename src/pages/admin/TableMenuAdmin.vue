                ...
                <tbody>
                    <tr class="border-2 border-gray-300">
                        ...
                        <td class="flex justify-center items-center w-full h-full">
                            <p class="bg-yellow-500 w-fit px-2">Đã đặt</p>
                        </td>
                        <td class="text-center">01:12:12</td>
                    ...
                    <tr class="border-2 border-gray-300">
                        ...
                        <td class="flex justify-center items-center w-full h-full">
                            <p class="bg-green-500 w-fit px-2">Có sẵn</p>
                        </td>
                        <td class="text-center">2:12:12</td>
                        <td class="text-center">
                            <div class="flex justify-center items-center h-full ">
                                <div
                                    class="w-10 h-10 text-gray-800 hover:bg-gray-400 hover:cursor-pointer rounded-lg relative group">
                    ...
                    <tr class="border-2 border-gray-300">
                        ...
                        <td class="flex justify-center items-center w-full h-full">
                            <p class="bg-red-500 w-fit px-2">Đang dùng</p>
                        </td>
                        <td class="text-center">1:12:12</td>
                        <td class="text-center">
                            <div class="flex justify-center items-center h-full ">
                                <div
                                    class="w-10 h-10 text-gray-800 hover:bg-gray-400 hover:cursor-pointer rounded-lg relative group">
                    ...
                    <tr class="border-2 border-gray-300">
                        ...
                        <td class="text-center">3:12:12</td>
                        <td class="text-center">
                            <div class="flex justify-center items-center h-full ">
                                <div
                                    class="w-10 h-10 text-gray-800 hover:bg-gray-400 hover:cursor-pointer rounded-lg relative group">
